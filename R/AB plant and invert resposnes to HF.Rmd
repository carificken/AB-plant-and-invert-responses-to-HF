...
veg_pa <- read.csv("ABMI veg cleaned.csv")

# load HF data 
setwd("/Users/cari/Desktop/Waterloo/AB plant and invert responses to HF/data/cleaned/")
hf <- read.csv("Alb wetlands HF.csv") %>% select(Protocol, NRNAME, WetlandType, Site, Year, HFCategory, FEATURE_TY, Area_km2)
...
```{r echo=F, warning=F, message=F}
  ...
  {
    setwd("/Users/cari/Desktop/Waterloo/AB plant and invert responses to HF/data/raw/climate/")
